...
def gen_trtllm_gen_fused_moe_sm100_module() -> JitSpec:
    ...
    return gen_jit_spec(
        ...
        [
            ...
            jit_env.FLASHINFER_CSRC_DIR / "routingRenormalize/launchBlockKernel.cu",
            jit_env.FLASHINFER_CSRC_DIR / "routingRenormalize/launchClusterKernel.cu",
            jit_env.FLASHINFER_CSRC_DIR / "routingRenormalize/launchHistogramKernel.cu",
            jit_env.FLASHINFER_CSRC_DIR
            / "routingRenormalize/launchHistogramScoresKernel.cu",
            jit_env.FLASHINFER_CSRC_DIR
            / "routingRenormalize/launchInitExpertCounts.cu",
            jit_env.FLASHINFER_CSRC_DIR / "routingRenormalize/launchOffsetsKernel.cu",
